...
#%%
"""Addition as a mapping problem (the beginners mistake)
the problem solved has multiple inputs but was techinacally not a sequence prediction problem, and can be solved by a MLP"""
...
def random_sum_pairs(n_examples, n_numbers, largest):
	"""Generate pairs of numbers and their sum"""
	X, y = list(), list()
...
for i in range(20):
	...
	print("expected={}, predicted={} error={}".format(expected[i], predicted[i],error))


#%%
"""Addition as a sequence prediction problem
use: input ['1','2','+','3'] output ['1','5'] so seq2seq"""
